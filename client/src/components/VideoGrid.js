      ...
      <GridItem size={size}>
        ...
        >
          {isModalOpen ? (
            ...
            >
              <p style={{ fontSize: "calc(2px + 0.5vh)", marginBottom: "5px" }}>
                Select the odd man out:
              </p>
              <div
                key={currentPlayer.uid}
                style={{ fontSize: "calc(2px + 0.5vh)", marginBottom: "5px" }}
              >
            ...
            <>
              ...
              <p style={{ fontSize: "calc(2px + 0.5vh)" }}>{"Remaining"}</p>
            </>
          )}
        </div>
      </GridItem>
