...
const CreateRoom = (props) => {
    ...
    const handlePromptClick = (buttonLabel) => {
        ...
        setUserData(prevState => {
            ...
            const existingIndex = prevState.Item.prompts.findIndex(prompt => {  
              return Object.keys(JSON.parse(prompt))[0] === Object.keys(buttonLabel)[0];
            });
    ...
    const dummyPrompts = [{id:0, uuid:"abc123", prompt:'Prompt 1', question:"Are you a Kanye West Fan?", omoAns:"No", notOmoAns:"Yes", count:0}, 
    {id:1, prompt:'Prompt 2', uuid:"xyz789", question:"Are you apart of the LGBTQIA+ community and or non-bindary?", omoAns:"No", notOmoAns:"Yes", count:0}, 
    {id:2, prompt:'Prompt 3', uuid:"jkl456", question:"Are you married", omoAns:"Yes", notOmoAns:"No", count:0}]
    ...
    return (
        <div  style={style}>   
            ...
            <div style={{paddingBottom:50, display: 'flex', flexDirection:'column', justifyContent: 'center', alignItems: 'center',}}>
                ...
                <input onChange={(e) => { handleNameChange(e);}} type="text" placeholder="name" value={name} ></input>
                <button disabled={userData.Item.prompts.length === 0 || !userData.Item.name || userData.Item.name.length === 0} onClick={startSearch} key={'startSearchButton'}>Confirm</button> 
            </div>  
            {/* <div style={{paddingBottom:50, display: 'flex', flexDirection:'column', justifyContent: 'center', alignItems: 'center',}}>
            ...
            <label style={{padding:5}}>Answer one or more questions below to be able to play OMO</label>
